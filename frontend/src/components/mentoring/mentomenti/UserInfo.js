...
export default function UserInfo({ m_id, m_name, m_p_intro, m_c_number, mr_score, post_number, cm_number }) {
  ...
  return (
    <>
      <Link to={{
        pathname: `/mentoring/mentiview/${m_id}`,
        state: {
          m_name: m_name
        }
      }}>
        <div className="mentorinfo__container">
          <div className="profile__image">
            <img className="mentor__image" src="/assets/profileDefaultImage.png" />
          ...
          <div className="mentor__info">
            ...
            <button className="subscribe__btn" onClick={handleOnClick}>Follow</button>
          </div>
